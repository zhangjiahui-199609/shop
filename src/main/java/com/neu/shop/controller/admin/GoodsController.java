...
import com.neu.shop.util.UuidUtils;
...
public class GoodsController {
    ...
    @RequestMapping("/shop/admin/goods/showjson")
    @ResponseBody
    ...
    @RequestMapping(value = "/shop/admin/goods/update", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/shop/admin/goods/delete/{goodsid}", method = RequestMethod.DELETE)
    @ResponseBody
    ...
    @Transactional
    @RequestMapping("/admin/goods/addGoodsSuccess")
    public String addGoods(Goods goods,
                           @RequestParam MultipartFile[] fileToUpload,
                           @RequestParam MultipartFile fileDetailUpload,
        ...
        if (fileDetailUpload != null) {
            String realPath = request.getSession().getServletContext().getRealPath("/");
            String imageName = fileDetailUpload.getOriginalFilename();
            String imagePath = realPath + "shopimage" + File.separatorChar + imageName;
            //把图片路径存入数据库中
            goods.setDesimgpath(imageName);
            //存商品详情图片
            fileDetailUpload.transferTo(new File(imagePath));
...
//                String imagePath = UUID.randomUUID().toString().replace("-", "") + multipartFile.getOriginalFilename();
    ...
    @RequestMapping("/admin/goods/addCategory")
    ...
    @RequestMapping("/admin/goods/addCategoryResult")
    ...
    @RequestMapping("/shop/admin/goods/saveCate")
    @ResponseBody
    ...
    @RequestMapping("/shop/admin/goods/deleteCate")
    @ResponseBody
